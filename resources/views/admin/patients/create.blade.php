  ...
  <div class="row">
    <div class="col-md-8">
      <div class="card card-primary card-outline">
        ...
        <!-- /.card-header -->
        <div class="card-body">
          <input name="title" class="form-control form-control-lg" type="text" placeholder="patient Title">
          <br>
          <input name="description" class="form-control form-control-lg" type="text" placeholder="patient Description">
