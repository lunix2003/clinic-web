            ...
            <div class="row g-5">
                ...
                <div class="col-lg-6 wow fadeInUp" data-wow-delay="0.5s">
                    <div class="bg-light rounded h-100 d-flex align-items-center p-5">
                        <form action="{{route('patient.patient_appointment')}}" method="post" enctype="multipart/form-data">
                            @csrf
                            <div class="row g-3">
                                ...
                                <div class="col-12">
                                    <textarea class="form-control border-0" name="problem" rows="5" placeholder="Describe your problem"></textarea>
                                </div>
                                <div class="col-12">
